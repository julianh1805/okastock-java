...
class UtilisateurServiceTest {
    ...
    void itShouldLoadUserByUsername() {
        ...
        given(utilisateurRepository.findByEmail(email)).willReturn(
                Optional.of(new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72dfe"), "Test", 12345678910111L, 44300, 666666666L, "https://test.com", "-", true, email, motDePasse)));
        //When
        ...
        assertThat(userDetails.getAuthorities().stream().findFirst().get().getAuthority()).isEqualTo(Role.USER.toString());
    }
    ...
    void itShouldThrowExceptionIfNomIsEmptyWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), null, 12345678910111L, 44300, 666666666L, "http://www.siteweb.com", "-", true, "test@test.com", "1234AZER");
        //When
    ...
    void itShouldThrowExceptionIfNomIsLessThan3LengthWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), "Te", 12345678910111L, 44300, 666666666L, "http://www.siteweb.com", "-", true, "test@test.com", "1234AZER");
        //When
        Set<ConstraintViolation<Utilisateur>> violations = validator.validate(utilisateur);
    ...
    void itShouldThrowExceptionIfNomIsMoreThan30LengthWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), "Test test test test test test test tes", 12345678910111L, 44300, 666666666L, "http://www.siteweb.com", "-", true, "test@test.com", "1234AZER");
        //When
        Set<ConstraintViolation<Utilisateur>> violations = validator.validate(utilisateur);
        this.assertViolation(violations, "Le nom d'entreprise doit faire entre 3 et 30 caractères.");
    }
    ...
    void itShouldThrowExceptionIfSiretIsNullWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), "Test", null, 44300, 666666666L, "http://www.siteweb.com", "-", true, "test@test.com", "1234AZER");
        //When
        Set<ConstraintViolation<Utilisateur>> violations = validator.validate(utilisateur);
    ...
    void itShouldThrowExceptionIfTelephoneIsNullWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), "Test", 12345678910111L, 44300, null, "http://www.siteweb.com", "-", true, "test@test.com", "1234AZER");
        //When
        Set<ConstraintViolation<Utilisateur>> violations = validator.validate(utilisateur);
    ...
    void itShouldThrowExceptionIfEmailIsNullWhenSave() {
        //Given
        Utilisateur utilisateur = new Utilisateur(UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72df4"), "Test", 12345678910111L, 44300, 666666666L, "http://www.siteweb.com", "-", true, null, "1234AZER");
        //When
        Set<ConstraintViolation<Utilisateur>> violations = validator.validate(utilisateur);
    ...
    void itShouldUpdate() {
        //Given
        UUID utilisateurId = UUID.fromString("e59ed17d-db7c-4d24-af6c-5154b3f72dfe");
        Utilisateur utilisateurToUpdate = new Utilisateur(utilisateurId, "Test", 12345678910111L, 44300, 666666666L, "http://www.test.com", "-", true, "test@test.com", "1234AZER");
